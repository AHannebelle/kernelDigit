...
[hog_4x4, vis4x4] = extractHOGFeatures(img,'CellSize',[4 4], 'Numbins', 12, 'UseSignedOrientation',true);
[hog_7x7, vis7x7] = extractHOGFeatures(img,'CellSize',[7 7], 'Numbins', 12, 'UseSignedOrientation',true);
[hog_14x14, vis14x14] = extractHOGFeatures(img,'CellSize',[14 14], 'Numbins', 12, 'UseSignedOrientation',true);
% size(hog_4x4)
% size(hog_14x14)
% size(hog_7x7)
